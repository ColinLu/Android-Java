...
import com.colin.library.android.album.api.filter.IFilterAudio;
 ...
 * 描述： TODO
 */
public class Audio<Returner, Result, Cancel> extends ChooseFilterMedia<Returner, Result, Cancel>
        implements IAudio<Returner>, IFilterAudio<Returner> {
    public Audio(@MediaType int mediaType, @IntRange(from = 1) int limit) {
