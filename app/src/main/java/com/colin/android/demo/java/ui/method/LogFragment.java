...
public class LogFragment extends AppFragment<FragmentLogBinding> {
    ...
    public void initView(@Nullable Bundle bundle) {
        ...
        mBinding.mButtonLogD.setOnClickListener(v -> LogUtil.d("String%d %f %f", 1, 2.0D, 3.0F));
        mBinding.mButtonLogW.setOnClickListener(v -> LogUtil.w("tag", "String%d %f %f", 1, 2.0D, 3.0F));
        ...
        mBinding.mButtonLogXml.setOnClickListener(v -> LogUtil.xml(LogLevel.E, "xmlTag", XML));
