 ...
 * 描述： 多媒体获取 图片
 */
public abstract class ChooseMediaImage<Returner, Result, Cancel> extends BaseChooseMedia<Returner, Result, Cancel>
        implements IChooseMedia.Image<Returner>, IFilter.Image<Returner> {
    ...
    public void start(@NonNull Context context) {
        ...
        bundle.putBoolean(Constants.MEDIA_MULTIPLE_MODE, mMultipleMode);
