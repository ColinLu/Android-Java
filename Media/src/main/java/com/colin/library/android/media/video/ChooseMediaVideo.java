 ...
 * 描述： 多媒体获取 视频
 */
public class ChooseMediaVideo<Returner, Result, Cancel> extends BaseChooseMedia<Returner, Result, Cancel>
        implements IChooseMedia.Video<Returner>, IFilter.Video<Returner> {
