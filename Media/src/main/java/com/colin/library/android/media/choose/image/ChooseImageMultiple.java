...
public class ChooseImageMultiple extends ChooseMediaImage<ChooseImageMultiple, List<MediaFile>, String> implements
        IMultiple<ChooseImageMultiple, List<MediaFile>> {
