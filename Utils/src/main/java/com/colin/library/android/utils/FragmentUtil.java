...
public final class FragmentUtil {
     ...
     * Add fragment.
     *
     * @param manager     The manager of fragment.
     * @param add         The fragment will be add.
     * @param containerId The id of container.
     */
    public static void add(@NonNull final FragmentManager manager,
    ...
    public static void add(@NonNull final FragmentManager manager,
        ...
        add(manager, add, containerId, null, false, enterAnim, exitAnim, 0, 0);
    }
    ...
    public static void add(@NonNull final FragmentManager manager,
                           ...
                           @AnimatorRes @AnimRes final int enterAnim,
                           @AnimatorRes @AnimRes final int exitAnim) {
        add(manager, add, containerId, null, isAddStack, enterAnim, exitAnim, 0, 0);
    }
    ...
    public static void add(@NonNull final FragmentManager manager,
        ...
        add(manager, add, containerId, null, false, enterAnim, exitAnim, popEnterAnim, popExitAnim);
    }
