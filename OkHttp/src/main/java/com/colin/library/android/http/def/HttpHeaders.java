...
public final class HttpHeaders {
    ...
    private HttpHeaders(@NonNull Builder builder) {
        this.namesAndValues = builder.namesAndValues.toArray(new String[builder.namesAndValues.size()]);
    }

    private HttpHeaders(@NonNull String[] namesAndValues) {
    ...
    public static final class Builder {
        ...
        public Builder set(@NonNull String name, @NonNull String value, boolean replace) {
            checkNameAndValue(name, value);
            if (replace) remove(name);
            return addLenient(name, value);
        }

        public Builder set(@NonNull Map<String, String> map, boolean replace) {
            for (Map.Entry<String, String> entry : map.entrySet()) {
