...
public class ContentBody implements IRequestBody {
    ...
    public ContentBody(@NonNull String content, @NonNull String contentType, @Nullable String charset) {
    ...
    public okhttp3.RequestBody toRequestBody(@Nullable String charset) {
        return okhttp3.RequestBody.Companion.create(mContent, getMediaType(charset));
    }
